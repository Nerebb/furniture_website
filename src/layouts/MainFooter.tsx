    ...
    <footer className="py-4 bg-white sm:py-6 border-t border-solid border-priBlack-100">
      <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
          <a href={process.env.NEXT_PUBLIC_BASE_URL} className="flex items-center space-x-2">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center ">© 2023 <a href={process.env.NEXT_PUBLIC_BASE_URL} className="hover:underline">Flowbite™</a>. All Rights Reserved.
        </span>
